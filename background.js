...
// Example Socket.io setup for betting interaction
const socket = io.connect('YOUR_SOCKET_IO_ENDPOINT');

socket.on('prepare_bet', () => {
    startFreezing('http://bettingurl.com', 1);
});
